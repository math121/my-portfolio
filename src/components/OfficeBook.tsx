    ...
    <Card className="w-full flex-row rounded-none shadow-none bg-[#05293b] text-[#e5e7e0] py-10">
      ...
      <CardBody className="w-1/2 py-0">
        ...
        <div className="flex gap-5">
          <a
            href="https://github.com/math121/office-booking-frontend"
            role="button"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#e5e7e0]"
          >
            <span className="[&>svg]:h-8 [&>svg]:w-8 [&>svg]:fill-[#fff] flex items-center gap-3">
          ...
          <a
            href="https://github.com/math121/office-booking-backend"
            role="button"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#e5e7e0]"
